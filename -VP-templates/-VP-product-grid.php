  ...
  [--IF PRODUCT.Field48--]
    <script>
      $(function(){
        ...
        var flagsUp = "";
        if (flagVal.indexOf("free")!==-1){
          flagsUp+="<span class='icon-truck popup-flag free-ship-flag' data-popuptext='Free Shipping'></span><br><br>"
        }
        if (flagVal.indexOf("eco")!==-1){
          flagsUp+="<span class='icon-leaf popup-flag eco-friendly-flag' data-popuptext='Eco-Friendly'></span><br><br>"
        }
        if (flagVal.indexOf("popular")!==-1){
          flagsUp+="<span class='icon-heart popup-flag popular-flag' data-popuptext='Popular'></span><br><br>"
        }
        if (flagVal.indexOf("energy")!==-1){
          flagsUp+="<span class='icon-power-cord popup-flag energy-saver-flag' data-popuptext='Energy Saver'></span><br><br>"
        }
        if (flagVal.indexOf("industrial")!==-1){
          flagsUp+="<span class='icon-wrench popup-flag industrial-flag' data-popuptext='Industrial'></span><br><br>"
        }
        if (flagVal.indexOf("pet")!==-1){
...
[-- DEFINE MORE_INFO_PAGE --]
  ...
  <head>
    ...
    <!--custom css file-->
    <link href="/AE/css/fonts-min.css" rel="stylesheet">
  ...
  <body id="moreInfo">
    ...
    <div class="site-wrap">
                    ...
                    [--IF PRODUCT.Field48--]
                      <script>
                        $(function(){
                          ...
                          $('#flag-[--PRODUCT.sku--]').append(flagsUp);
                        });
                      </script>
                    [--END_IF--]
                      ...
                      <div class="item">
                        ...
                        [-- ELSE --]
                          [-- IF PRODUCT.MoreInformationGraphic --]
                            <div align="center">
                              <a rel="lightbox[product-mediumImage]" href='//vacplus.com/media/[-- IMAGE Product.MoreInformationGraphic --]' data-title='[-- PRODUCT.Name --]' ><img class='mediumImage img-responsive mid' alt='[-- PRODUCT.Name --]' title='[-- PRODUCT.Name --]' [-- PRODUCT.MoreInformationGraphic REMOVE_HTML--] style="max-height:400px;" /></a>
                            </div>
                          [--ELSE--]
                            <div align="center">
                              <a rel="lightbox[product-noImage]" href='//vacplus.com/media/images/more_comingsoon.png' data-title='[-- PRODUCT.Name --]' ><img class="mediumImage img-responsive mid" alt='[-- PRODUCT.Name --]' title='[-- PRODUCT.Name --]' src="//vacplus.com/media/images/more_comingsoon.png" hspace="0" vspace="0" style="max-height:400px;"></a>
                            </div>
                          [-- END_IF --]
                        [-- END_IF --]
                        <!--360 img-->
                ...
                <div id="quickview-sidebar-mobile" class="col-xs-12 col-sm-5 col-md-5 col-lg-4"><!--mobile target sidebar-->
                  <div id="quickview-sidebar" class="top-sidebar col-xs-12"><!--clone this sidebar-->
                    <div class="product-detail-desc" class="clearfix">
                      <span id="desktop-price-block">
                        ...
                        <div id="#price-block" class="clearfix">
                          ...
                          [-- IF PRODUCT.DisplayPrice --]
                            ...
                            [--ELSE--]
                              ...
                              <div class="price-top price">
                                <div>
                                  [-- IF PRODUCT.SaleOn --]
                                    <span class="sale-price">Sale:
                                      <span>[-- PRODUCT.SaleAmount --]</span>
                                    </span>
                                    <span class="list-price">Reg.
                          ...
                          <div class="col-sm-12 col-md-12 col-lg-12" style="padding:0;">
                            <div id="product_just_stars" class="small more-info-reviews col-sm-12 col-md-5 col-lg-5" style="padding:0;"></div>
                            <!--end stars rating-->
                            <!--socmed buttons-->
                            <div class="social-buttons col-sm-12 col-md-7 col-lg-7" style="padding:0;">
                      ...
                      <script>
                        $(function(){
                          callOuts="[--PRODUCT.Field48--]";
                          if (callOuts.indexOf("free")!==-1){
                            $('.shipping-co').css('display','block');
                          }else{
                            $('.shipping-co').css('display','none');
                          }
                          if (callOuts.indexOf("eco")!==-1){
                            $('.hypo-co').css('display','block');
                          }else{
                            $('.hypo-co').css('display','none');
                          }
                          if (callOuts.indexOf("popular")!==-1){
                            $('.popular-co').css('display','block');
                          }else{
                            $('.popular-co').css('display','none');
                          }
                          if (callOuts.indexOf("energy")!==-1){
                            $('.energy-co').css('display','block');
                          }else{
                            $('.energy-co').css('display','none');
                          }
                          if (callOuts.indexOf("industrial")!==-1){
                            $('.industrial-co').css('display','block');
                          }else{
                            $('.industrial-co').css('display','none');
                          }
                          if (callOuts.indexOf("pet")!==-1){
                            $('.pet-co').css('display','block');
                          }else{
                            $('.pet-co').css('display','none');
                          }
                        })
                      </script>
                      <div class="vp-callouts shipping-co">
                        <h4>Free Shipping</h3><span style="font-size:14px;">On orders over $49. Most orders ship same day and are delivered within 2-5 business days.</p>
                      </div>
                      <div class="vp-callouts hypo-co">
                        <h4>Hypoallergenic</h3><span style="font-size:14px;">Designed to trap almost all of the smaller particles and prevent them from being re-circulated into the ambient air.</p>
                      </div>
                      <div class="vp-callouts popular-co">
                          <h4>Popular</h3><span style="font-size:14px;">This item is a best seller and popular amongst our staff and customers.</p>
                        </div>
                      <div class="vp-callouts energy-co">
                        <h4>Energy Saver</h3><span style="font-size:14px;">Designed for cost effective performance.</p>
                      </div>
                      <div class="vp-callouts industrial-co">
                        <h4>Industrial</h3><span style="font-size:14px;">Built for industrial and heavy duty use.</p>
                      </div>
                      <div class="vp-callouts pet-co">
                        <h4>Pet Purrrfect</h3><span style="font-size:14px;">Robust design eliminates tough pet hair, dander &amp; dirt. Meow!</p>
                      </div>
                      <!--end callouts-->
                    </div>
                  </div>
      ...
      [-- INCLUDE -VP-footer --]
      [-- INCLUDE SignInModal.sst PROCESS --]
    </div><!--end site wrap-->
